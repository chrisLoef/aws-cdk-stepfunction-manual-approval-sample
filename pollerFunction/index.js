...
exports.handler = function () { return __awaiter(void 0, void 0, void 0, function () {
    var taskParams, activityTask, input, emailParams, sesResult, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 6, , 7]);
                return [4 /*yield*/, stepfunctions.getActivityTask(taskParams).promise()];
            case 2:
                activityTask = _a.sent();
                console.log(activityTask);
                if (!(activityTask.taskToken && activityTask.input)) return [3 /*break*/, 4];
                ...
                return [4 /*yield*/, ses.sendEmail(emailParams).promise()];
            case 3:
                sesResult = _a.sent();
